...
Aktualnie implementacja jest czÍ∂ciowa, wiÍkszo∂Ê API istnieje, ale
spora czÍ∂Ê funkcjonalno∂ci wewnÍtrznej jest nie dokoÒczona.

%description -l pt_BR
O Lesstif È um clone do Motif, com a API compatÌvel.
...
O MWM È um gerenciador de janelas que adere largamente ‡ especificaÁ„o
Motif.
...
Summary(es):	Bibliotecas y archivos de inclusiÛn para desarrollo del lesstif
...
Bibliotecas y archivos de inclusiÛn que se requieren para desarrollar
...
aplicaÁıes baseadas no lesstif/motif-%{motif_ver}.

%package static
Summary:	Static Lesstif library
Summary(es):	Bibliotecas para lesstif en versiÛn est·tica
...
Bibliotecas para lesstif en versiÛn est·tica.
